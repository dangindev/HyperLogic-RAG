...
sys.path.insert(0, '/home/dangnh3/MICCAI2026/R2Gen')
sys.path.insert(0, '/home/dangnh3/MICCAI2026/M2KT_baseline')
...
def load_r2gen_model(checkpoint_path, device='cuda'):
    ...
    class Args:
        def __init__(self):
            ...
            self.ann_path = '/home/dangnh3/MICCAI2026/R2Gen/data/mimic_cxr/annotation.json'
...
def quick_eval_checkpoint(checkpoint_path, model_type='hyperlogic', num_samples=50, device='cpu'):
    ...
    if model_type == 'hyperlogic':
        ...
        class Args:
            def __init__(self):
                self.image_dir = '/home/dangnh3/MICCAI2026/R2Gen/data/mimic_cxr/images/'
                self.ann_path = '/home/dangnh3/MICCAI2026/R2Gen/data/mimic_cxr/annotation.json'
                self.dataset_name = 'mimic_cxr'
                self.max_seq_length = 100
                self.threshold = 10
...
def main():
    ...
    if args.quick or args.model in ['hyperlogic', 'baseline']:
        ...
        if args.model == 'r2gen':
            ...
            from modules.dataloaders import R2DataLoader
            class EvalArgs:
                image_dir = '/home/dangnh3/MICCAI2026/R2Gen/data/mimic_cxr/images/'
                ann_path = '/home/dangnh3/MICCAI2026/R2Gen/data/mimic_cxr/annotation.json'
